      ...
      <nav className='max-w-7xl mx-auto flex justify-between'>
        ...
        <div className='flex items-center'>
          <Link to='/books?sortBy=views'>
            <button className='opacity-80 text-lg font-medium hover:opacity-100 mx-2'>Most Popular</button>
          </Link>
          <Link to='/books?sortBy=rating'>
            <button className='opacity-80 text-lg font-medium hover:opacity-100 mx-2'>Top Rated</button>
          </Link>
